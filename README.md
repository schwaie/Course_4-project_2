...
This repository contains the plots and scripts to answer the questions related to course project 2 of the course Exploratory Data Analysis.

This file contains the details of the assignment. 
